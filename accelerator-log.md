...
```json
{
  ...
  "gitbranch" : "main",
  "giturl" : "https://github.com/viktoriousss/python01.git",
  "minscale" : "1",
  "projectName" : "python01"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"deploymentType":"workload","gitbranch":"main","artifactVersion":"0.0.1-beta","artifactId":"python01","giturl":"https://github.com/viktoriousss/python01.git","projectName":"python01","minscale":"1"}
┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input16002219469586214488, --data-values-file, /tmp/accelerator-options5400037813079455844.json, --output-files, /tmp/ytt-output9629163792284997254]
...
┃ ┃ ┃ ┃ ┃ Debug .DS_Store didn't match [**/*.py, **/*.txt, **/*.sh, Procfile, .gitignore] -> excluded
